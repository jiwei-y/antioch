...
alternatives are ondemand, powersave, performance and conservative.")
  ...
  (cpu-energy-perf-policy-on-ac     ;; renewed
   (string "balance_performance")
   "Set CPU performance versus energy saving policy on AC.  Alternatives are
performance, normal, powersave.")

  (cpu-energy-perf-policy-on-bat    ;; renewed
   (string "balance_power")
   "Same as @code{cpu-energy-perf-policy-ac} but on BAT mode.")
...
in AC mode.  Values are stated as a percentage of the available performance.")
  ...
  (cpu-hwp-dyn-boost-on-ac?     ;; new
   maybe-boolean
   "Enable Intel/AMD CPU dynamic boost feature on AC mode.")

  (cpu-hwp-dyn-boost-on-bat?    ;; new
   maybe-boolean
   "Same as @code{cpu-hwp-dyn-boost-on-ac?} on BAT mode.")
